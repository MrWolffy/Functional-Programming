...
(define (adder-list a1 a2 sum)
  (define (build-adder lst1 lst2 lst3)
    (if (null? lst1)
        (void)
        (begin (adder (car lst1) (car lst2) (car lst3))
               (build-adder (cdr lst1) (cdr lst2) (cdr lst3)))))
  (build-adder a1 a2 sum))

(define (set-value-list! lst ref new-value informant)
  (if (has-value? (list-ref lst ref))
      (forget-value! (list-ref lst ref) informant)
      (void))
  (((list-ref lst ref) 'set-value!) new-value informant))

(define (get-value-list lst)
  (if (null? lst)
      '()
      (cons (get-value (car lst))
            (get-value-list (cdr lst)))))
